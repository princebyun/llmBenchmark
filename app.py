...
with st.sidebar:
    ...
    st.markdown("<p style='text-align: center; color: #666; font-size: 13px; margin-top: -10px;'>내 PC 하드웨어의 LLM모델 성능을 확인해보세요</p>", unsafe_allow_html=True)
